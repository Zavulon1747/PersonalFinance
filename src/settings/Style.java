...
public final class Style {
    ...
    public static final Font FONT_BUTTON_TOOLBAR = new Font("Roboto", Font.BOLD, 14);
    public static final Font FONT_MAIN_BUTTON = new Font("Roboto", Font.BOLD, 14);
    ...
    public static final ImageIcon ICON_TOOLBAR_CURRENCY = new ImageIcon("images/currencies.png");
