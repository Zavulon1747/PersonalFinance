...
public class Statistics {
    ...
    public static HashMap<String, Double> getDataForCharOnIncomeArticles() {
        return getDataForCharOnArticles(true);
    }

    public static HashMap<String, Double> getDataForCharOnExpArticles() {
        return getDataForCharOnArticles(false);
    }

    private static HashMap<String, Double> getDataForCharOnArticles(boolean income) {
